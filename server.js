...
const url = 'mongodb+srv://$_USERNAME_$:$_PASSWORD_$@cluster0.gh1vvod.mongodb.net/$_DB_NAME_$?retryWrites=true&w=majority&appName=Cluster0';

const databaseUser = 'piyush';
const databasePassword = 'piyush123';
const databaseName = 'imgGen';
